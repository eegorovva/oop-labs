...
public class UserRepository : IUserRepository
{
    ...
    public void InsertUser(long id, long pincode)
    {
        const string sql = """
    ...
    public void AddMoney(long id, decimal value)
    {
        ...
        const string sql = """
                           UPDATE Accounts
                           SET AccountBalance = AccountBalance + @value
                           WHERE AccountId = @id
                           """;
    ...
    public void RemoveMoney(long id, decimal value)
    {
        User? user = FindUserById(id);
